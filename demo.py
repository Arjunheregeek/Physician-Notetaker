import os
from medical_nlp.pipeline import MedicalPipeline
import json
...
# Sample transcript from assignment
TRANSCRIPT = """
...
def main():
    ...
    # NOTE: Set OPENAI_API_KEY in environment or pass it here
    api_key = os.getenv("OPENAI_API_KEY")
    if not api_key:
        print("!!! NO OPENAI API KEY DETECTED. SOAP/SUMMARIZATION WILL BE SKIPPED/FAIL !!!")
    
    pipeline = MedicalPipeline(openai_api_key=api_key)
    results = pipeline.process_conversation(TRANSCRIPT)
